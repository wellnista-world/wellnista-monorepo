          ...
          <div className="flex flex-col md:flex-row w-full gap-6">
            ...
            <div className="flex flex-col items-center justify-center bg-white p-4 rounded-lg shadow w-full mb-8">
              ...
              <p className="text-sm text-neutral">
                {(analysisResult.nutriments.carbohydrates ?? 0) / 15} คาร์บ ({Math.min(((analysisResult.nutriments.carbohydrates ?? 0) / 15) / maxCarbs * 100, 100).toFixed(0)}% ของ {maxCarbs} คาร์บสูงสุด)
              </p>
            </div>
          </div>
